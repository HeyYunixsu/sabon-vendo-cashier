...
int PUMP1 = 15, PUMP2 = 16, PUMP3 =  6, PUMP4 = 17, PUMP5 = 18;
int LED1 =  5, LED2 = 27, LED3 =  4, LED4 = 22, LED5 = 19;

int PUMP_TRIGGER_HIGH = 0;
int PUMP_TRIGGER_LOW  = 1;

std::map<int, int> pin_pump {
    {1, PUMP1}, {2, PUMP2}, {3, PUMP3}, {4, PUMP4}, {5, PUMP5}
};
std::map<int, int> pin_led {
    {1, LED1}, {2, LED2}, {3, LED3}, {4, LED4}, {5, LED5}
};
...
void init_hardware_config(const std::map<std::string, std::string> &config)
{
    ...
    load_int("BTN4", BTN4); load_int("BTN5", BTN5);
    load_int("PUMP1", PUMP1); load_int("PUMP2", PUMP2); load_int("PUMP3", PUMP3);
    load_int("PUMP4", PUMP4); load_int("PUMP5", PUMP5);
    load_int("LED1", LED1); load_int("LED2", LED2); load_int("LED3", LED3);
    load_int("LED4", LED4); load_int("LED5", LED5);
    load_int("PUMP_TRIGGER_HIGH", PUMP_TRIGGER_HIGH);
    load_int("PUMP_TRIGGER_LOW",  PUMP_TRIGGER_LOW);

    pin_pump   = {{1, PUMP1}, {2, PUMP2}, {3, PUMP3}, {4, PUMP4}, {5, PUMP5}};
    pin_led    = {{1, LED1},  {2, LED2},  {3, LED3},  {4, LED4},  {5, LED5}};
    pin_button = {{1, BTN1},  {2, BTN2},  {3, BTN3},  {4, BTN4},  {5, BTN5}};

    static const struct { int coins; double seconds; } defaults[6] = {
        {},
        {5, 2.777777777777778},
        {5, 1.363636363636364},
        {5, 1.25},
